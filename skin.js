...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		player.addListener('varchanged_opt_3d_preview_1', function(event) {
			if (hotspotTemplates.hasOwnProperty('ht_node_1')) {
				for(var i = 0; i < hotspotTemplates['ht_node_1'].length; i++) {
					hotspotTemplates['ht_node_1'][i].ggEvent_varchanged_opt_3d_preview_1();
				}
			}
		});
	};
	function SkinHotspotClass_ht_node_1(parentScope,hotspot) {
		...
		hs='data:image/svg+xml;base64,'+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		me._chevron_white_lower0.logicBlock_visible = function() {
			...
			if (me._chevron_white_lower0.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._chevron_white_lower0.style.transition='opacity 500ms ease 0ms';
		...
		me._chevron_white_lower0.logicBlock_visible();
		...
		me._ht_node.appendChild(me._chevron_white_lower0);
		...
		me._chevron_black0.logicBlock_visible = function() {
			...
			if (me._chevron_black0.ggCurrentLogicStateVisible != newLogicStateVisible) {
				...
				me._chevron_black0.style.transition='opacity 500ms ease 0ms';
		...
		me._chevron_black0.logicBlock_visible();
		...
		me._ht_node.appendChild(me._chevron_black0);
		...
		el=me.__3d_code0=document.createElement('div');
		el.ggId="_3d_code";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1,def:'' };
		el.ggVisible=true;
		el.className="ggskin ggskin_code ";
		...
		el.setAttribute('style',hs);
		el.style.transformOrigin='50% 50%';
		me.__3d_code0.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me.__3d_code0.ggUpdatePosition=function (useTransition) {
		}
		me._ht_node.appendChild(me.__3d_code0);
